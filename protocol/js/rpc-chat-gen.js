...
export const localPostFileAttachmentLocalNonblockRpcPromise = (params: LocalPostFileAttachmentLocalNonblockRpcParam, waitingKey?: string): Promise<LocalPostFileAttachmentLocalNonblockResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.postFileAttachmentLocalNonblock', params, callback: (error: RPCError, result: LocalPostFileAttachmentLocalNonblockResult) => (error ? reject(error) : resolve(result)), waitingKey}))
...
export type ChatUiChatAttachmentPreviewUploadDoneRpcParam = $ReadOnly<{convID: ConversationID, outboxID: OutboxID}>
export type ChatUiChatAttachmentPreviewUploadStartRpcParam = $ReadOnly<{convID: ConversationID, outboxID: OutboxID}>
export type ChatUiChatAttachmentUploadDoneRpcParam = $ReadOnly<{convID: ConversationID, outboxID: OutboxID}>
export type ChatUiChatAttachmentUploadOutboxIDRpcParam = $ReadOnly<{outboxID: OutboxID}>
export type ChatUiChatAttachmentUploadProgressRpcParam = $ReadOnly<{convID: ConversationID, outboxID: OutboxID, bytesComplete: Long, bytesTotal: Long}>
export type ChatUiChatAttachmentUploadStartRpcParam = $ReadOnly<{convID: ConversationID, outboxID: OutboxID}>
...
export type LocalPostFileAttachmentLocalNonblockRpcParam = $ReadOnly<{arg: PostFileAttachmentArg}>
...
type LocalPostFileAttachmentLocalNonblockResult = PostLocalNonblockRes
